...
class Deployer(object):
    ...
    def __init__(self, subscription_id, resource_group, pub_ssh_key_path):
    ...
    def deploy(self, rgregion, vmregion, vmname):
        ...
        template_path = os.path.join(os.path.dirname(__file__), 'templates', 'qrank-client.json')
